...
/* Define if ARP support is enabled */
#define ENABLE_ARP 1

/* Define if BitTorrent support is enabled */
#define ENABLE_BITTORRENT 1

/* Define if CHDLC support is enabled */
#define ENABLE_CHDLC 1

/* Define if DCERPC support is enabled */
#define ENABLE_DCERPC 1

/* Define if DHCP support is enabled */
#define ENABLE_DHCP 1

/* Define if DNP3 support is enabled */
#define ENABLE_DNP3 1

/* Define if DNS support is enabled */
#define ENABLE_DNS 1

/* Define if ENIP support is enabled */
#define ENABLE_ENIP 1

/* Define if ERSPAN support is enabled */
#define ENABLE_ERSPAN 1

/* Define if ESP support is enabled */
#define ENABLE_ESP 1

/* Define if FTP support is enabled */
#define ENABLE_FTP 1

/* Define if GENEVE support is enabled */
#define ENABLE_GENEVE 1

/* Define if GRE support is enabled */
#define ENABLE_GRE 1

/* Define if HTTP support is enabled */
#define ENABLE_HTTP 1

/* Define if IKE support is enabled */
#define ENABLE_IKE 1

/* Define if IMAP support is enabled */
#define ENABLE_IMAP 1

/* Define if IPv6 support is enabled */
#define ENABLE_IPV6 1

/* Define if Kerberos5 support is enabled */
#define ENABLE_KRB5 1

/* Define if LDAP support is enabled */
#define ENABLE_LDAP 1

/* Define if MODBUS support is enabled */
#define ENABLE_MODBUS 1

/* Define if MPLS support is enabled */
#define ENABLE_MPLS 1

/* Define if MQTT support is enabled */
#define ENABLE_MQTT 1

/* Define if NFS support is enabled */
#define ENABLE_NFS 1

/* Define if NSH support is enabled */
#define ENABLE_NSH 1

/* Define if NTP support is enabled */
#define ENABLE_NTP 1

/* Define if PGSQL support is enabled */
#define ENABLE_PGSQL 1

/* Define if POP3 support is enabled */
#define ENABLE_POP3 1

/* Define if PPP support is enabled */
#define ENABLE_PPP 1

/* Define if PPPoE support is enabled */
#define ENABLE_PPPOE 1

/* Define if QUIC support is enabled */
#define ENABLE_QUIC 1

/* Define if RAW support is enabled */
#define ENABLE_RAW 1

/* Define if RDP support is enabled */
#define ENABLE_RDP 1

/* Define if RFB support is enabled */
#define ENABLE_RFB 1

/* Define if SCTP support is enabled */
#define ENABLE_SCTP 1

/* Define if SIP support is enabled */
#define ENABLE_SIP 1

/* Define if SLL support is enabled */
#define ENABLE_SLL 1

/* Define if SMB support is enabled */
#define ENABLE_SMB 1

/* Define if SMTP support is enabled */
#define ENABLE_SMTP 1

/* Define if SNMP support is enabled */
#define ENABLE_SNMP 1

/* Define if SSH support is enabled */
#define ENABLE_SSH 1

/* Define if TCP support is enabled */
#define ENABLE_TCP 1

/* Define if Telnet support is enabled */
#define ENABLE_TELNET 1

/* Define if TEREDO support is enabled */
#define ENABLE_TEREDO 1

/* Define if TFTP support is enabled */
#define ENABLE_TFTP 1

/* Define if TLS support is enabled */
#define ENABLE_TLS 1

/* Define if UDP support is enabled */
#define ENABLE_UDP 1

/* Define if VLAN support is enabled */
#define ENABLE_VLAN 1

/* Define if VNTAG support is enabled */
#define ENABLE_VNTAG 1

/* Define if VXLAN support is enabled */
#define ENABLE_VXLAN 1

/* Define if WebSocket support is enabled */
...
/* Assuming htp_config_set_allow_space_uri function in bundled libhtp */
#define HAVE_HTP_CONFIG_SET_ALLOW_SPACE_URI 1
...
#define PACKAGE_STRING "suricata 8.0.0-dev"
...
/* Git revision */
#define REVISION 4b8155d 2024-12-05
...
/* make Suricata notify systemd on startup */
